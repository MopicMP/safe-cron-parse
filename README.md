...
> Safe parse and validate cron expressions

[![PyPI version](https://badge.fury.io/py/safe-cron-parse.svg)](https://pypi.org/project/safe-cron-parse/)
...
```bash
pip install safe-cron-parse
```

## Quick Start

```python
from safe_cron_parse import parse
...
from safe_cron_parse import batch
